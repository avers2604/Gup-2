...
Найдено шесть дефектов, пять исправлены. Шестой — Ф-4 — вынесен на решение
Заказчика: приложение, ходящее через PgBouncer, после переключения лидера
...
Пока решение не принято, приёмочный RTO обязан измеряться
